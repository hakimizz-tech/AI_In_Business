...
const Footer: React.FC = () => {
  return (
    <footer id="contact" className="bg-white border-t border-border/50 pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li><a href="mailto:info@aibusinessoptimizers.com" className="hover:text-primary transition-colors">info@aibusinessoptimizers.com</a></li>
              <li><a href="tel:+11234567890" className="hover:text-primary transition-colors">+1 (123) 456-7890</a></li>
            </ul>
        ...
        <div className="pt-8 border-t border-border/50 text-center text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} AI Business Optimizers. All rights reserved.</p>
